...
class RepositoryImpl : Repository {
    ...
    override fun getSpecificPictureOfTheDayFromServer(date: String): POD {
        val dto =
            PictureOfTheDayDataRepo.API.getSpecificPictureOfTheDay(date, ApiUtils.apiKey).execute()
                .body()
        return POD(
    ...
    override fun getMarsPictureFromServer(date: String): List<MarsPhoto> {
        val dto =
            PictureOfTheDayDataRepo.API.getMarsSetOfPictures(date, ApiUtils.apiKey).execute().body()
    ...
    override fun getEarthPictureFromServer(date: String): EarthPhoto {
        val dto = PictureOfTheDayDataRepo.API.getEarthSetOfPictures(date, ApiUtils.apiKey).execute()
            .body()
